...
const Main = () => {
  const prompt1 = "What is Magnet Forensics?";
  const prompt2 = "What is the history of Magnet Forensics";
  const prompt3 = "What is digital investigation";
  const prompt4 = "What is Mobile device forensics?";
      ...
      {!showResult ? (
        <>
          <div className="greet">
              ...
              <p>Welcome to the Magnet Forensics ChatBot</p>
          </div>
          <div className="cards">
